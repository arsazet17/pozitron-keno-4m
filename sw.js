const CACHE='keno-full20-v1.0.4';
const SHELL=[
 './?v=1.0.4',
 './index.html?v=1.0.4',
 './style.css?v=1.0.4',
 './full20-app.js?v=1.0.4',
...
self.addEventListener('fetch',e=>{
 ...
 if(u.pathname.includes('/data/full20_')){e.respondWith(fetch(new Request(e.request,{cache:'no-store'})));return}
